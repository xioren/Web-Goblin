    ...
    def main(self):
        ...
        for target in self.args['targets'][self.ID]:
            if 'gallery' in target:
                ...
                query = self.parser.to_json({"operationName":"MODEL_QUERY","variables":{"modelUri":f"{model}","site":f"{location}"},"query":"query MODEL_QUERY($modelUri: String, $site: String) {\n  model(modelUri: $modelUri, site: $site) {\n    id\n    gender\n    firstName\n    lastName\n    slug\n    inTown\n    uiColour\n    uiLogoColour\n    bio\n    image {\n      ... on Image {\n        sourceUrl\n        __typename\n      }\n      __typename\n    }\n    heroImage {\n      ... on Image {\n        sourceUrl\n        width\n        height\n        __typename\n      }\n      __typename\n    }\n    heroImageDesktop {\n      ... on Image {\n        sourceUrl\n        width\n        height\n        __typename\n      }\n      __typename\n    }\n    portfolio {\n      ... on Image {\n        sourceUrl\n        orientation\n        __typename\n      }\n      __typename\n    }\n    polaroids {\n      ... on Image {\n        sourceUrl\n        __typename\n      }\n      __typename\n    }\n    runways {\n      ... on Image {\n        sourceUrl\n        __typename\n      }\n      __typename\n    }\n    covers {\n      ... on Image {\n        sourceUrl\n        __typename\n      }\n      __typename\n    }\n    campaigns {\n      ... on Image {\n        sourceUrl\n        __typename\n      }\n      __typename\n    }\n    videos {\n      ... on Video {\n        sourceUrl\n        videoType\n        __typename\n      }\n      __typename\n    }\n    books {\n      name\n      slug\n      assets {\n        ... on Image {\n          sourceUrl\n          __typename\n        }\n        ... on Video {\n          sourceUrl\n          videoType\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    measurements {\n      fieldName\n      fieldValue\n      fieldValueHuman {\n        us\n        metric\n        uk\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n"})

                response = self.parser.from_json(self.post(self.API_URL, data=query).content)
